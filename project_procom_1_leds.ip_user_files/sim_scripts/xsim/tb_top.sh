...
#
# Script generated by Vivado on Wed Jun 17 02:28:41 -0300 2026
...
# script info
echo -e "tb_top.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
simulate()
{
  xsim tb_top -key {Behavioral:sim_1:Functional:tb_top} -tclbatch cmd.tcl -protoinst "protoinst_files/vio.protoinst" -protoinst "protoinst_files/ila.protoinst" -log simulate.log
}
...
Usage: tb_top.sh [-rerun]\n\
Usage: tb_top.sh [-reset_run]\n\
Usage: tb_top.sh [-clean]\n\
